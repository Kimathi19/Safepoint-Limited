    ...
    return (
      <div className="mt-16 min-h-[80vh] flex items-center flex-col justify-center">
        ...
        <p className=" text-sm  lg:text-base  text-center w-1/2 mx-auto my-8">
          ...
          back to the previous page or contact us for more information.
        </p>

        <Link to="/" className="bg-green-500 py-2 px-6 rounded-md  text-white mx-auto flex items-center justify-evenly">
